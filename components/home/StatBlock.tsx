...
function MarkerBar() {
  return (
    <svg width="48" height="64" viewBox="0 0 48 64" aria-hidden>
      <rect x="0" y="40" width="8" height="24" fill="#2D4FE5" />
      <rect x="14" y="24" width="8" height="40" fill="#2D4FE5" opacity="0.7" />
      <rect x="28" y="8" width="8" height="56" fill="#2D4FE5" opacity="0.45" />
    </svg>
  );
}
...
function MarkerArc() {
  return (
    <svg width="64" height="64" viewBox="0 0 64 64" aria-hidden>
      <circle cx="32" cy="32" r="26" stroke="#FAFAF7" strokeOpacity="0.15" strokeWidth="2" fill="none" />
      <path
        ...
        strokeLinecap="round"
      />
      <text x="32" y="36" textAnchor="middle" className="font-mono" fontSize="9" fill="#FAFAF7" letterSpacing="1">
        50%
      </text>
    </svg>
  );
  ...
  return (
    <svg width="80" height="44" viewBox="0 0 80 44" aria-hidden>
      <path
        ...
        strokeLinecap="round"
      />
      <circle cx="42" cy="6" r="3" fill="#2D4FE5" />
    </svg>
  );
}
